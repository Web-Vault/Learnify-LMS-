                        ...
                        <div class="main-area">
                                ...
                                <div class="edit-course" id="edit">
                                        <div class="course-card-part">
                                                <div class="main-header">
                                                        <p class="header-text">Previous Notifications! </p>
                                                        <hr>
                                                </div>
                                                        ...
                                                        <form action="#" method="post">
                                                                ...
                                                                if ($result->num_rows >= 1) {
                                                                        while ($row = $result->fetch_assoc()) {
                                                                                ...
                                                                                $notification_div = $row['division'];

                                                                                if($notification_div == ""){
                                                                                        $notification_div = "All";
                                                                                }
                                                                                
                                                                                echo "Division : " . $notification_div;
                                                                                echo "<div class='field'>
                                                                                          <div class='input'>
                                                                                                    <textarea name='my-bio' id='my-bio' disabled>' $notification '</textarea>
                                                                                          </div>
                                                                                </div>";
                                                                        }
                                                                } else {
                                                                ...
                                                                if (isset($_POST['notify'])) {
                                                                        ...
                                                                        if ($escaped_selected_div == "") {
                                                                                $insert = "INSERT INTO `notification`( `notification_content`, `division`) VALUES ('$notification','')";
                                                                        } else {
                                                                                $insert = "INSERT INTO `notification`( `notification_content`, `division`) VALUES ('$notification','$escaped_selected_div')";
                                                                        }
                                                                ...
                                                                ?>
                                                                        ...
                                                                        <script>
                                                                                window.location.href = "admin-notification.php";
                                                                        </script>
                                                                ...
                                                                ?>
                                                                <div class="main-header">
                                                                        <p class="header-text">Send Every User a Notification! </p>
                                                                        <hr>
                                                                </div>

                                                                <div class="field">
                                                                        <div class="input">
                                                                                <textarea name="notification" id="notification" placeholder="Notification..."></textarea>
                                                                        </div>
                                                                </div>
                                                                ...
                                                                <div class="field">
                                                                        ...
                                                                        <div class="next">
                                                                                <input type="submit" value="Commit Changes...." class="next-btn" name="notify">
                                                                        </div>
                                                                </div>
